...
namespace ImprovedHordes.Wandering.Animal
{
    public sealed class WorldWildernessWanderingAnimalHordePopulator : WorldWildernessHordePopulator<WanderingAnimalHorde>
    {
        ...
        public WorldWildernessWanderingAnimalHordePopulator(float worldSize, WorldPrefabPOIScanner scanner, HordeSpawnParams spawnData) : base(worldSize, scanner, spawnData, WANDERING_ANIMAL_WILDERNESS_SPARSITY.Value, false)
        {
        }
